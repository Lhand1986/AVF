...
/**
 Base class for all HandLeviAVFGTT views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the HandLeviAVFGTT view hierarchy (such as wrapped iOS UIViews) was touched.
