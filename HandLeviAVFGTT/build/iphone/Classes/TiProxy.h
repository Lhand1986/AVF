...
//Rare exceptions to indicate a bug in the _handleviavfgtt code (Eg, function that a subclass should have implemented)
...
/**
 The base class for HandLeviAVFGTT proxies.
 */
