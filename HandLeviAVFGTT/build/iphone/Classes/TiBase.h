...
// in simulator we redefine to format for HandLeviAVFGTT Developer console
...
{\
	NSString * exceptionName = [@"org.handleviavfgtt." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.handleviavfgtt";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHandLeviAVFGTTNativeItemNone = -1, 
	UIHandLeviAVFGTTNativeItemSpinner = -2,
	UIHandLeviAVFGTTNativeItemProgressBar = -3,
	
	UIHandLeviAVFGTTNativeItemSlider = -4,
	UIHandLeviAVFGTTNativeItemSwitch = -5,
	UIHandLeviAVFGTTNativeItemMultiButton = -6,
	UIHandLeviAVFGTTNativeItemSegmented = -7,
	
	UIHandLeviAVFGTTNativeItemTextView = -8,
	UIHandLeviAVFGTTNativeItemTextField = -9,
	UIHandLeviAVFGTTNativeItemSearchBar = -10,
	
	UIHandLeviAVFGTTNativeItemPicker = -11,
	UIHandLeviAVFGTTNativeItemDatePicker = -12,
	
	UIHandLeviAVFGTTNativeItemInfoLight = -13,
	UIHandLeviAVFGTTNativeItemInfoDark = -14,
	
	UIHandLeviAVFGTTNativeItemDisclosure = -15,
	
	UIHandLeviAVFGTTNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all HandLeviAVFGTT instances of
