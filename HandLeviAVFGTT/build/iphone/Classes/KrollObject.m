...
//@interface HandLeviAVFGTTObject : NSObject
//@end

@interface HandLeviAVFGTTObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HandLeviAVFGTTObject class]])
		{
			for (NSString *key in [[(HandLeviAVFGTTObject*)o modules] allKeys])
			{
