...
@interface HandLeviAVFGTTObject : KrollCoverageObject {
#else
@interface HandLeviAVFGTTObject : KrollObject {
#endif
@private
...
extern NSString * HandLeviAVFGTT$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	HandLeviAVFGTTObject *_handleviavfgtt;
    KrollObject* console;
	BOOL shutdown;
