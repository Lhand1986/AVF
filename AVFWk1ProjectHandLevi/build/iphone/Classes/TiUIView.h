...
/**
 Base class for all AVFWK1ProjectHandLevi1508 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AVFWK1ProjectHandLevi1508 view hierarchy (such as wrapped iOS UIViews) was touched.
