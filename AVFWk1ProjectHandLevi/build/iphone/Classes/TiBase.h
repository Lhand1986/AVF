...
// in simulator we redefine to format for AVFWK1ProjectHandLevi1508 Developer console
...
{\
	NSString * exceptionName = [@"org.avfwk1projecthandlevi1508." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avfwk1projecthandlevi1508";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVFWK1ProjectHandLevi1508NativeItemNone = -1, 
	UIAVFWK1ProjectHandLevi1508NativeItemSpinner = -2,
	UIAVFWK1ProjectHandLevi1508NativeItemProgressBar = -3,
	
	UIAVFWK1ProjectHandLevi1508NativeItemSlider = -4,
	UIAVFWK1ProjectHandLevi1508NativeItemSwitch = -5,
	UIAVFWK1ProjectHandLevi1508NativeItemMultiButton = -6,
	UIAVFWK1ProjectHandLevi1508NativeItemSegmented = -7,
	
	UIAVFWK1ProjectHandLevi1508NativeItemTextView = -8,
	UIAVFWK1ProjectHandLevi1508NativeItemTextField = -9,
	UIAVFWK1ProjectHandLevi1508NativeItemSearchBar = -10,
	
	UIAVFWK1ProjectHandLevi1508NativeItemPicker = -11,
	UIAVFWK1ProjectHandLevi1508NativeItemDatePicker = -12,
	
	UIAVFWK1ProjectHandLevi1508NativeItemInfoLight = -13,
	UIAVFWK1ProjectHandLevi1508NativeItemInfoDark = -14,
	
	UIAVFWK1ProjectHandLevi1508NativeItemDisclosure = -15,
	
	UIAVFWK1ProjectHandLevi1508NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AVFWK1ProjectHandLevi1508 instances of
