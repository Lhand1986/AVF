...
//@interface AVFWK1ProjectHandLevi1508Object : NSObject
//@end

@interface AVFWK1ProjectHandLevi1508Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AVFWK1ProjectHandLevi1508Object class]])
		{
			for (NSString *key in [[(AVFWK1ProjectHandLevi1508Object*)o modules] allKeys])
			{
