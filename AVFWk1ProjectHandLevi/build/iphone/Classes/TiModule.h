...
/**
 The base class for all AVFWK1ProjectHandLevi1508 modules
 */
...
/**
 AVFWK1ProjectHandLevi1508 Platform calls this method on startup.
 */
-(void)startup;

/**
 AVFWK1ProjectHandLevi1508 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 AVFWK1ProjectHandLevi1508 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 AVFWK1ProjectHandLevi1508 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 AVFWK1ProjectHandLevi1508 Platform calls this method on resume.
 @param sender The sender of the event.
 */
