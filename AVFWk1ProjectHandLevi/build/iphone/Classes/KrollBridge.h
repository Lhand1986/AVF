...
@interface AVFWK1ProjectHandLevi1508Object : KrollCoverageObject {
#else
@interface AVFWK1ProjectHandLevi1508Object : KrollObject {
#endif
@private
...
extern NSString * AVFWK1ProjectHandLevi1508$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AVFWK1ProjectHandLevi1508Object *_avfwk1projecthandlevi1508;
    KrollObject* console;
	BOOL shutdown;
