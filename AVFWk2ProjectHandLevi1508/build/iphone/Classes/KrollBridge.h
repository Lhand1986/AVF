...
@interface AVFWk2ProjectHandLevi1508Object : KrollCoverageObject {
#else
@interface AVFWk2ProjectHandLevi1508Object : KrollObject {
#endif
@private
...
extern NSString * AVFWk2ProjectHandLevi1508$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AVFWk2ProjectHandLevi1508Object *_avfwk2projecthandlevi1508;
    KrollObject* console;
	BOOL shutdown;
