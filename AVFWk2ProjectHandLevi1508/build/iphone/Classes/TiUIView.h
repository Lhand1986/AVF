...
/**
 Base class for all AVFWk2ProjectHandLevi1508 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AVFWk2ProjectHandLevi1508 view hierarchy (such as wrapped iOS UIViews) was touched.
