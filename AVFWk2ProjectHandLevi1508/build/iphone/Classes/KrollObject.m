...
//@interface AVFWk2ProjectHandLevi1508Object : NSObject
//@end

@interface AVFWk2ProjectHandLevi1508Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AVFWk2ProjectHandLevi1508Object class]])
		{
			for (NSString *key in [[(AVFWk2ProjectHandLevi1508Object*)o modules] allKeys])
			{
