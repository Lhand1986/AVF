...
// in simulator we redefine to format for AVFWk2ProjectHandLevi1508 Developer console
...
{\
	NSString * exceptionName = [@"org.avfwk2projecthandlevi1508." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avfwk2projecthandlevi1508";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVFWk2ProjectHandLevi1508NativeItemNone = -1, 
	UIAVFWk2ProjectHandLevi1508NativeItemSpinner = -2,
	UIAVFWk2ProjectHandLevi1508NativeItemProgressBar = -3,
	
	UIAVFWk2ProjectHandLevi1508NativeItemSlider = -4,
	UIAVFWk2ProjectHandLevi1508NativeItemSwitch = -5,
	UIAVFWk2ProjectHandLevi1508NativeItemMultiButton = -6,
	UIAVFWk2ProjectHandLevi1508NativeItemSegmented = -7,
	
	UIAVFWk2ProjectHandLevi1508NativeItemTextView = -8,
	UIAVFWk2ProjectHandLevi1508NativeItemTextField = -9,
	UIAVFWk2ProjectHandLevi1508NativeItemSearchBar = -10,
	
	UIAVFWk2ProjectHandLevi1508NativeItemPicker = -11,
	UIAVFWk2ProjectHandLevi1508NativeItemDatePicker = -12,
	
	UIAVFWk2ProjectHandLevi1508NativeItemInfoLight = -13,
	UIAVFWk2ProjectHandLevi1508NativeItemInfoDark = -14,
	
	UIAVFWk2ProjectHandLevi1508NativeItemDisclosure = -15,
	
	UIAVFWk2ProjectHandLevi1508NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AVFWk2ProjectHandLevi1508 instances of
