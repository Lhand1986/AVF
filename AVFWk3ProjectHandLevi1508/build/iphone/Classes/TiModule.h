...
/**
 The base class for all AVFWk3ProjectHandLevi1508 modules
 */
...
/**
 AVFWk3ProjectHandLevi1508 Platform calls this method on startup.
 */
-(void)startup;

/**
 AVFWk3ProjectHandLevi1508 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 AVFWk3ProjectHandLevi1508 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 AVFWk3ProjectHandLevi1508 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 AVFWk3ProjectHandLevi1508 Platform calls this method on resume.
 @param sender The sender of the event.
 */
