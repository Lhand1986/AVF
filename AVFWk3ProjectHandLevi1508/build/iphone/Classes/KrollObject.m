...
//@interface AVFWk3ProjectHandLevi1508Object : NSObject
//@end

@interface AVFWk3ProjectHandLevi1508Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AVFWk3ProjectHandLevi1508Object class]])
		{
			for (NSString *key in [[(AVFWk3ProjectHandLevi1508Object*)o modules] allKeys])
			{
