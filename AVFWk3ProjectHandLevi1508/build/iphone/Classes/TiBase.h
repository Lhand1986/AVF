...
// in simulator we redefine to format for AVFWk3ProjectHandLevi1508 Developer console
...
{\
	NSString * exceptionName = [@"org.avfwk3projecthandlevi1508." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avfwk3projecthandlevi1508";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVFWk3ProjectHandLevi1508NativeItemNone = -1, 
	UIAVFWk3ProjectHandLevi1508NativeItemSpinner = -2,
	UIAVFWk3ProjectHandLevi1508NativeItemProgressBar = -3,
	
	UIAVFWk3ProjectHandLevi1508NativeItemSlider = -4,
	UIAVFWk3ProjectHandLevi1508NativeItemSwitch = -5,
	UIAVFWk3ProjectHandLevi1508NativeItemMultiButton = -6,
	UIAVFWk3ProjectHandLevi1508NativeItemSegmented = -7,
	
	UIAVFWk3ProjectHandLevi1508NativeItemTextView = -8,
	UIAVFWk3ProjectHandLevi1508NativeItemTextField = -9,
	UIAVFWk3ProjectHandLevi1508NativeItemSearchBar = -10,
	
	UIAVFWk3ProjectHandLevi1508NativeItemPicker = -11,
	UIAVFWk3ProjectHandLevi1508NativeItemDatePicker = -12,
	
	UIAVFWk3ProjectHandLevi1508NativeItemInfoLight = -13,
	UIAVFWk3ProjectHandLevi1508NativeItemInfoDark = -14,
	
	UIAVFWk3ProjectHandLevi1508NativeItemDisclosure = -15,
	
	UIAVFWk3ProjectHandLevi1508NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AVFWk3ProjectHandLevi1508 instances of
