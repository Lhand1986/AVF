...
@interface AVFWk3ProjectHandLevi1508Object : KrollCoverageObject {
#else
@interface AVFWk3ProjectHandLevi1508Object : KrollObject {
#endif
@private
...
extern NSString * AVFWk3ProjectHandLevi1508$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AVFWk3ProjectHandLevi1508Object *_avfwk3projecthandlevi1508;
    KrollObject* console;
	BOOL shutdown;
